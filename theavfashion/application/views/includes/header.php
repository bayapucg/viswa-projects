				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="nav-item "><a href="<?php echo base_url(); ?>cart" class="cart p-2 text-white" style="color:#fff;border-radius:8px;"><span class="fa fa-shopping-cart " style="color:#fff"></span><span id="cartItem" style="margin-left:3px;color:#fff"><sup style="color:#fff;background:#222;height:40px;width:40px;border-radius:50%;padding: 3px 6px;"><?php echo $countCart333; ?></sup></span></a></li>
