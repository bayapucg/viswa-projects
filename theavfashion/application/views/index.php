  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
     <img src="<?php echo base_url();?>assets/img/banner1.png" alt="Giftcard" width="1100" height="500">
    <div class="carousel-caption">
     ...
     <img src="<?php echo base_url();?>assets/img/banner2.png" alt="Giftcard" width="1100" height="500">
    <div class="carousel-caption">
        <div class="main_slider_content">
			<h6>Spring / Summer Collection 2020</h6>
			<h1>Get up to 30% Off New Arrivals</h1>
