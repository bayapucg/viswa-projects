		...
		<div class="container">
			<div class="breadcrumb-banner " >
				<div class="text-center pt-4">
					<h1><?php echo ucfirst($getgiftcardinfo->gcname); ?> </h1>
            ...
            <div class="card mb-10">
               <div class="card-body store-body">
				 ...
				 <input type="hidden" id="cardtext" name="cardtext" value="<?php echo ucfirst($getgiftcardinfo->gcname); ?>">
                  <div class="product-payment-details row">
				   <div class="product-info sm-hide col-md-6">
                     ...
                     <div class="info-wrap bg-white p-lg-5 cust-pd-mar col-md-6">
                              ...
                              <div class="col-md-12">
                                 <div class="row">
                                    <div class="form-group col-md-6 col-6 cus-btn">
                                       <input type="button" onClick="validateFun();" value="Check" class="btn btn-dark btn-block" style="">
                                    </div>
                                    <div class="text-center  bg-white col-md-6 col-6 cus-btn">
                                       <a href="<?php echo $getgiftcardinfo->base_url; ?>" target="_blank"  class="btn  btn-warning border-0 text-white btn-block" >Buy Now</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
