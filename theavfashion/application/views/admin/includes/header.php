...
<link rel="icon" href="<?php echo base_url();?>assets/img/fav.png">
    <title><?php echo $page_title;?>theavfashion</title>
				...
				<ul class="nav metismenu" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element" >
							<span >
								<img alt="image" class="img-responsive" src="<?php echo base_url();?>assets/img/logo.png"  style="margin: 0 auto;display: block;background:#fff;padding:10px;border-radius:8px;"/>
							</span>
