...
<div class="wrapper-content animated fadeInRight">
					...
					<form method="POST" action="" enctype="multipart/form-data" id="product_item_form" name="product_item_form">
						...
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
							 ...
							 <input type="hidden" id="product_url" name="product_url" value="<?php echo $itemdetails->product_url; ?>">
							<div class="clearfix"></div> <br>
							<?php 
								$catimg = "";$catthumbimg = "";
							...
							<?php if(isset($itemdetails->product_image) && $itemdetails->product_image!=""){  ?>
								...
								<div class="col-xs-2"> 
									...
									?>
									<img src="<?php echo base_url().'product_images/'.$sImage;?>" width="100">
								</div>
							<?php }else{ ?>
								<div class="col-xs-8"> 
							...
							<div class="clearfix"></div><br>
							<span id="hid_dis" style="<?php echo $style1; ?>">
								<div class="col-xs-4">
							...
							<span id="hid_fix" style="<?php echo $style2; ?>">
								<div class="col-xs-4">
    ...
    <script>
		function cat_validate(){
			...
			var h_product_image = $("#h_product_image").val();
