...
<body class="gray-bg" style="background-image: url('<?php echo base_url(); ?>admin_assets/img/bg-login.png');">
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            <div class="col-md-6 col-md-offset-3" style="padding-top: 45px">
                <div class="ibox-content" style="background: #ddd;">
                    <img src="<?php echo base_url();?>assets/img/logo.png" class="img-responsive" style="margin:0 auto;">						<form name="loginSubmit" id="loginSubmit" method="POST" >
                        <hr>
                        <h2 class="font-bold text-center" style="color: #fff"><b>Admin Login</b></h2>
