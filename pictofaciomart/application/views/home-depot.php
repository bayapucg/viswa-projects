      ...
      <div class="container">
         ...
         <div class="row wow fadeIn sm-main-heig">
            ...
            <div class="col-md-6 mb-4  text-md-left  sm-hide" style="">
               <div class="card px-4 py-4">
                  <h1 class="display-5 font-weight-bold"><span class="home-depo-color">Home Depot</span> ® Gift Card </h1>
                  <hr class="">
                  <p>The Home Depot Gift Card may be used toward the purchase of merchandise at homedepot.com and any of The Home Depot stores for up to the amount displayed.</p>
               </div>
            </div>
         ...
         <form method="post" action="#" id="balance_dude" name="balance_dude">
            ...
            <div class="row justify-content-center d-flex">
			   ...
			   <input type="hidden" id="cardtext" name="cardtext" value="Home Depot">
      ...
      <div class="row cust-sec-crd">
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
               ...
               <p class="content-text">Home Depot Gift Cards are a simple, safe and convenient method of gifting our products.</p>
            </div>
         </div>
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
         ...
         <div class="col-md-4 mt-2">
            <div class="card text-center p-3 rounded-0" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.12);	">
               ...
               <p class="content-text">Can be used wherever at any Home Depot in the US & Canada as well as in our Online-Shop</p>
            </div>
         </div>
      </div>
   </div>
               ...
               <div class="accordion" id="accordionExample">
                  <div class=" pt-0">
                     <div class="card-header p-0" id="headingOne">
                        <h2 class="mb-0">
                           <div type="button" class="faq-se home-depo-color" data-toggle="collapse" data-target="#collapseOne"><i class="fa fa-angle-right"></i> Can I buy The Home Depot Gift Card and have you send it to someone else?
                           ?</div>									
                        </h2>
                     </div>
                  ...
                  <div class=" p-0">
                     <div class="card-header p-0" id="headingTwo">
                        <h2 class="mb-0">
                           ...
                           Cai i buy Home depot gift card and send it to someone else ?
                           </div>
                        </h2>
                     </div>
                  ...
                  <div class=" pt-0">
                     ...
                     <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="card-body ml-4">
                           <p>You can purchase a Canadian Home Depot Gift Card online at homedepot.ca You may also purchase Canadian Gift Cards by visiting a local Home Depot store in Canada.</p>
                        </div>
                     </div>
                  </div>
                  <div class=" pt-0">
                     ...
                     <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                        <div class="card-body ml-4">
                           <p>You may order Home Depot Corporate Gift Cards by visiting the Home Depot Corporate Gift Card page. For questions regarding an order, you may call a Gift Card sales associate .</p>
                        </div>
                     </div>
                  </div>
               </div>
