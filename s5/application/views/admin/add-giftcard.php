                ...
                <div class="ibox-content">
					<form method="POST" action="" enctype="multipart/form-data" id="cate_form" name="cate_form">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input form-control" id="gcname" type="text" name="gcname" value="">
							...
							<div class="col-xs-8">
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<textarea rows="10" cols="100" class="mdl-textfield__input form-control" id="description" name="description"></textarea>
							...
							<div class="col-xs-8"> 
								<input accept="image/*" type="file" id="gcimage" name="gcimage" class="form-control" />
