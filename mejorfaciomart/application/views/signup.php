<!-- slider Area Start-->
    <div class="slider-area ">
        <!-- Mobile Menu -->
        <div class="single-slider slider-height1 d-flex align-items-center" data-background="assets/img/category.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="">
                            ...
                            <p>Mejorfaciomart is the digital fashion e-commerce website. Shop trendy, fresh, handpicked styles at the best prices. Shop Online, Buy and Check Gift Card Balance.</p>
