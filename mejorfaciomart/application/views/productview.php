							...
							<div class="card_area">
								<div class="product_count_area">
									...
									<div class="product_count d-inline-block">
										<span class="product_count_item inumber-decrement"> <i onClick="add_plus('minus')" class="fa fa-minus"></i></span>
										<input class="product_count_item input-number" type="text" id="cartitem" name="cartitem" value="1" min="1" max="10">
										<span class="product_count_item number-increment"> <i onClick="add_plus('plus')" class="fa fa-plus"></i></span>
									</div>
